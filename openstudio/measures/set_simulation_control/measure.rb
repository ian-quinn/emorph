...
class SetSimulationControl < OpenStudio::Measure::ModelMeasure
  ...
  def arguments(model)
    ...
    heating_sizing_factor.setDefaultValue(1.0)
    ...
    cooling_sizing_factor.setDefaultValue(1.0)
    ...
    do_plant_sizing.setDefaultValue(false)
    ...
    max_warmup_days.setDefaultValue(25)
    ...
    min_warmup_days.setDefaultValue(6)
    ...
    loads_convergence_tolerance.setDefaultValue(0.1)
    ...
    temp_convergence_tolerance.setDefaultValue(0.5)
    ...
    solar_distribution.setDefaultValue("FullExterior")
    ...
    max_hvac_iterations.setDefaultValue(8)
