...
# openstudio-sketchup-plugin/plugin/openstudio/user_scripts/Create Standard Building Shapes/Set_Rectangular_Floor_Plan.rb
...
class SetRectangularFloorPlan < OpenStudio::Measure::ModelMeasure
  ...
  def description
    return "Set rectangular floor plan with perimeter/core zoning"
  end

  def modeler_descrition
    return "Set rectangular floor plan with perimeter/core zoning"
  end
  ...
  def arguments(model)
    ...
    length = OpenStudio::Measure::OSArgument::makeDoubleArgument("length",false)
    length.setDisplayName("Building Length (m)")
    length.setDefaultValue(40.0)
    args << length

    width = OpenStudio::Measure::OSArgument::makeDoubleArgument("width",false)
    width.setDisplayName("Building Width (m)")
    width.setDefaultValue(20.0)
    args << width

    num_floors = OpenStudio::Measure::OSArgument::makeDoubleArgument("num_floors",false)
    num_floors.setDisplayName("Number of Floors")
    num_floors.setDefaultValue(1.0)
    args << num_floors

    floor_to_floor_height = OpenStudio::Measure::OSArgument::makeDoubleArgument("floor_to_floor_height",false)
    ...
    plenum_height = OpenStudio::Measure::OSArgument::makeDoubleArgument("plenum_height", false)
    plenum_height.setDisplayName("Plenum Height (m)")
    plenum_height.setDefaultValue(1.0)
    args << plenum_height

    perimeter_zone_depth = OpenStudio::Measure::OSArgument::makeDoubleArgument("perimeter_zone_depth", false)
    perimeter_zone_depth.setDisplayName("Perimeter Zone Depth (m)")
    perimeter_zone_depth.setDefaultValue(4.57)
    args << perimeter_zone_depth
